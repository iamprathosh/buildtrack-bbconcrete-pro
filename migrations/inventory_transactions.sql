...
-- GRANT SELECT, INSERT, UPDATE ON inventory_transactions TO authenticated;
-- GRANT SELECT ON inventory_transactions_with_details TO authenticated;
-- GRANT USAGE ON SEQUENCE inventory_transactions_id_seq TO authenticated;
