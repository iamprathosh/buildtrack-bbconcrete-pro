      ...
      <Card>
        <CardContent className="flex items-center justify-center py-10">
          <div className="text-center">
            ...
            <p className="text-lg font-medium text-muted-foreground">Loading vendors...</p>
          </div>
        </CardContent>
      </Card>
    )
        ...
        <CardContent className="flex items-center justify-center py-10">
          <div className="text-center">
            ...
            <p className="text-sm text-muted-foreground">
              Add your first vendor or adjust your filters
            </p>
          </div>
        </CardContent>
      </Card>
                          ...
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end">
                              ...
                              {vendor.status === 'active' && (
                                ...
                                >
                                  <Shield className="mr-2 h-4 w-4" />
                                  {actionLoading === vendor.id ? 'Processing...' : 'Deactivate'}
                                </DropdownMenuItem>
                              )}
