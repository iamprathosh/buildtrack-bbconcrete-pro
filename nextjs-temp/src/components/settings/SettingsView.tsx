...
export function SettingsView() {
  ...
  const [companySettings, setCompanySettings] = useState<CompanySettings>({
    name: 'BuildTrack Construction Pro',
    address: '123 Construction Ave, Building City, BC 12345',
    phone: '+1-555-123-4567',
    email: 'info@buildtrack-pro.com',
    website: 'https://www.buildtrack-pro.com',
    taxId: '12-3456789',
    ...
    apiKeys: [
      {
        id: '1',
        name: 'Mobile App API',
        key: 'bt_live_1234567890abcdef',
        permissions: ['read:projects', 'write:inventory'],
  ...
  const generateApiKey = () => {
    const newKey = {
      ...
      name: 'New API Key',
      key: `bt_live_${Math.random().toString(36).substring(2, 18)}`,
